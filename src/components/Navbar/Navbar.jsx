  ...
  return (
    <nav className="bg-primary1 shadow-md py-4 ">
      <div className="flex justify-between items-center" >
        <div  className="flex bg-primary2 items-center text-grayText justify-center  gap-2 py-2.5 px-2.5 min-w-[300px] max-w-xl rounded-md w-[100%] " >
        ...
        <div className="flex items-center justify-content-center gap-4" >
          <div className="relative" >
            ...
            <IoMdNotificationsOutline className="text-gray-400 text-[30px] " />
          </div>
