    ...
    return (
        ...
        <div  className="flex items-center justify-center flex-col  " >
          ...
          <div className="text-center" >
            <h1 className="text-xl md:text-2xl font-bold lg:text-4xl" >Sayed Udoy</h1>
            <h2 className="mt-3 text-lg" >Frontend webdelever at habluprogrammer</h2>
        ...
        <div className="bg-primary1/30 flex items-center justify-around py-10 px-5 mt-4" >
          {data.map((d) => (
            <div key={d.id} className="bg-primary1 w-full p-5 not-last:border-r text-center not-last:border-grayText/30" >
              <h5 className="text-xl md:text-3xl lg:text-5xl font-bold" >{d.count}</h5>
  ...
  return (
    <section className="bg-primary2 text-white/70">
      ...
      <div className="flex items-center justify-center py-10 gap-10" >
        {
            soacialLinks.map(s=>(
                <span className=" text-xl lg:text-3xl cursor-pointer hover:scale-[1.1] " >{s.icon}</span>
            ))
        }
      </div>
    </section>
